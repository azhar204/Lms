import { ChartNoAxesColumn, SquareLibrary, TrendingUp, Menu } from "lucide-react";
...
const Sidebar = () => {
  ...
  const navItems = [
    { to: "dashboard", icon: ChartNoAxesColumn, label: "Dashboard" },
    { to: "course", icon: SquareLibrary, label: "Courses" },
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
          ...
          <SheetContent side="left" className="w-[260px] p-6 bg-white dark:bg-gray-800">
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-gray-800 dark:text-white">ADMIN</h1>
            </div>
            {renderNavLinks()}
